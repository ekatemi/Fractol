...
static int	is_burning(double cr, double ci, t_fractal *fractal) //cr and ci is scaled x and y
{
	double	zr;
	double	zi;
	double	tmp;
...
void	render_burning(t_fractal *fractal)
{
	int		x;
	int		y;
	double	pr;
